...
Version  : 3.3.3
Release  : 44
URL      : https://cran.r-project.org/src/contrib/nleqslv_3.3.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/nleqslv_3.3.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659974506
...
R CMD INSTALL --preclean --install-tests --built-timestamp=${SOURCE_DATE_EPOCH} --build  -l %{buildroot}/usr/lib64/R/library nleqslv
