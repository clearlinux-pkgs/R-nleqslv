...
Version  : 3.3.1
Release  : 1
URL      : https://cran.r-project.org/src/contrib/nleqslv_3.3.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/nleqslv_3.3.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521231961
